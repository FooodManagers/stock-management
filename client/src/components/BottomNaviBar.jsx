    ...
    <div className="fixed z-50 w-full h-20 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-200 dark:border-gray-200 shadow-md">
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        >
          ...
          <span 
            className={`text-sm whitespace-nowrap ${
            selected === '/list' ? 'text-green': ''}`}>リスト</span>
        </Link>
        ...
        <div className="flex items-center justify-center">
          ...
          >
            ...
            <span className="text-sm text-gray-200 whitespace-nowrap">スキャン</span>
          </Link>
        </div>
        <Link
          to="/recipes"
        ...
        >
         <svg className={`w-6 h-6 mb-1 ${selected === '/recipes' ? 'fill-green' : 'text-gray-500 dark:text-gray-400 group-hover:fill-green dark:group-hover:fill-green'}`} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#6B7280">
          ...
          <span 
            className={`text-sm whitespace-nowrap ${
            selected === '/recipes' ? 'text-green': ''}`}>レシピ</span>
        </Link>
        <Link
          to="/settings"
        ...
        >
          ...
          <span 
           className={`text-sm whitespace-nowrap ${
            selected === '/settings' ? 'text-green': ''}`}>設定</span>
        </Link>
      </div>
    </div>
  );
