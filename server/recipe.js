...
const RAKUTEN_RECIPE_SEARCH_API_URL = 'https://app.rakuten.co.jp/services/api/Recipe/CategoryList/20170426';
const RAKUTEN_APP_ID = process.env.RAKUTEN_APP_ID || '1008386588204629342'; // .envファイルにAPIキーを保存
